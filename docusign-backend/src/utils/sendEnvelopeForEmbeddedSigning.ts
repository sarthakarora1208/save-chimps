 ...
 * @param {object} args
 */
const sendEnvelopeForEmbeddedSigning = async (args: any) => {
...
function makeEnvelope(args) {
  ...
  env.emailSubject = "Audit Report";

  // add the documents
  let doc1 = new docusign.Document(),
    doc1b64 = Buffer.from(docPdfBytes).toString("base64");
  doc1.documentBase64 = doc1b64;
  doc1.name = "Audit-Report"; // can be different from actual file name
...
function makeRecipientViewRequest(args) {
  ...
  viewRequest.returnUrl = args.dsReturnUrl + `?email=${args.signerEmail}`;
